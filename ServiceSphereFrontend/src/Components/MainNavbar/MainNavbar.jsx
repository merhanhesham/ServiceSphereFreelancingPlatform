...
export default function MainNavbar({ deleteUser, user }) {
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item active">
              <Link className="nav-link " aria-current="page" to="/entryHome">
                Home
              </Link>
            </li>
            <li className="nav-item active">
            ...
            <li className="nav-item active">
              <Link className="nav-link " aria-current="page" to="/ProjectDetails">
                Create Project
              </Link>
            </li>
