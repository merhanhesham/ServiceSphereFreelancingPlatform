...
export default function ClientNavbar({ deleteUser, user }) {
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item active">
              <Link className="nav-link " aria-current="page" to="/AllPosts">
               My Posts
              </Link>
            </li>
            <li className="nav-item active">
              <Link className="nav-link " aria-current="page" to="/talents">
               Talents
              </Link>
            </li>
